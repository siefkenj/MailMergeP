...
var mailmerge = {
	...
	prefs: function() {
		// populate mailmerge.prefs will all the stored preferences
		mailmergeUtils.mergePrefs(mailmerge);
	},
	...
	csv: function() {
		...
		file = mailmergeUtils.parseCsvLegacy(file, mailmerge.prefs.fielddelimiter, mailmerge.prefs.textdelimiter);
	...
	substitute: mailmergeUtils.substitute,
